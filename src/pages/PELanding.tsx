    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#F4F6FA' }}>
      ...
      >
        ...
        <div className="max-w-2xl mx-auto text-center relative z-10">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-white">
            ...
            <span className="text-[#FFBB00]">Due Diligence</span>
          </h1>
      ...
      <div className="px-4 py-16" style={{ backgroundColor: '#F4F6FA' }}>
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          <ValueProp
            icon={<Shield className="w-5 h-5" style={{ color: '#1AA0D0' }} />}
          ...
          />
          <ValueProp
            icon={<Tag className="w-5 h-5" style={{ color: '#1AA0D0' }} />}
      ...
      <div className="py-6 text-center text-sm text-slate-light" style={{ backgroundColor: '#F4F6FA' }}>
    ...
    >
      <div className="flex items-center gap-2 mb-2">
        <div
          ...
          style={{ backgroundColor: 'rgba(55,120,244,0.10)' }}
        >
          {icon}
        </div>
